<template>
  <div>
    ...
    <grid :cols="2" class="article-grids">
      <grid-item v-for="i in 4" :key="i" class="article" >
        <!-- <div class="article">
        ...
        <flexbox>
          <flexbox-item :span="8">
            <div class="article-title">
              <p class="main-title" >{{articles[i-1].title}}</p>
              <p class="sub-title" >{{articles[i-1].subtitle}}</p>
            </div>
          </flexbox-item>
          <flexbox-item>
            <div class="article-icon"><img :src="articles[i-1].img"></div>
          </flexbox-item>
        </flexbox>
      </grid-item>
    </grid>
    <panel :header="`列表`" :footer="footer" :list="list" :type="`1`"></panel>
...
<script>
import { Swiper, Grid, GridItem, GroupTitle, Flexbox, FlexboxItem, Panel, Search } from 'vux';
